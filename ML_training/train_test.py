...
trainer = Train.Trainer(dim=[[0, 0, 1],[1, 1, 1, 1, 1, 1]], model_type="DQN_2", batch_size = 32, datasets_directory="C:/ML_car/Datasets/Preprocessed/fsebcardom_996df78", models_directory="C:/ML_car/Models",
                        load_model=False)
